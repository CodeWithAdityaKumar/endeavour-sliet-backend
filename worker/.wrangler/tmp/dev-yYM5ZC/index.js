...
// .wrangler/tmp/bundle-zo5V5Y/strip-cf-connecting-ip-header.js
...
app.post("/api/auth/candidate-login", async (c) => {
  try {
...
app.get("/api/candidate/me", candidateAuthMiddleware, async (c) => {
  try {
...
app.put("/api/candidate/me", candidateAuthMiddleware, async (c) => {
  try {
    const jwtPayload = c.get("jwtPayload");
...
// .wrangler/tmp/bundle-zo5V5Y/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-zo5V5Y/middleware-loader.entry.ts
