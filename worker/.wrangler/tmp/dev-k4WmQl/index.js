...
// .wrangler/tmp/bundle-D8VxHQ/strip-cf-connecting-ip-header.js
...
async function addFirestoreDoc(collection, data, env2) {
  ...
  if (!res.ok) {
    const errText = await res.text();
    throw new Error(`Firestore doc creation failed: ${errText}`);
  }
...
function hashPassword(password) {
  return crypto_default.createHash("sha256").update(password).digest("hex");
}
...
// .wrangler/tmp/bundle-D8VxHQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-D8VxHQ/middleware-loader.entry.ts
